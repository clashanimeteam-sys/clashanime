export function AppBootSkeleton() {
  return (
    <div
      ...
      aria-live="polite"
    >
      <div className="h-14 border-b border-zinc-800/80 bg-black/70 backdrop-blur-md md:hidden" />
      ...
      <div className="h-[4.5rem] border-t border-zinc-800/80 bg-black/70 backdrop-blur-md md:hidden" />
    </div>
  );
}
