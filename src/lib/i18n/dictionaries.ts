...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    admin: {
      ...
      watchAnimeAutoHint: "VidLink + VidSrc ICU when no manual source exists.",
  ...
  ja: {
    ...
    admin: {
      ...
      watchAnimeAutoHint: "手動ソースがない場合 VidLink + VidSrc ICU。",
      watchAnimeAutoOn: "有効",
  ...
  ar: {
    ...
    admin: {
      ...
      watchAnimeAutoHint: "VidLink + VidSrc ICU عند عدم وجود مصدر يدوي.",
