...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    admin: {
      ...
      watchAnimeAutoHint: "VidLink + VidSrc via MAL/AniList — only when no ClashAnime HLS. Off by default.",
  ...
  ja: {
    ...
    admin: {
      ...
      watchAnimeAutoHint: "ClashAnime HLSがない場合のみ VidLink/VidSrc（MAL+AniList）。デフォルトはオフ。",
      watchAnimeAutoOn: "有効",
  ...
  ar: {
    ...
    admin: {
      ...
      watchAnimeAutoHint: "VidLink وVidSrc عبر MAL وAniList — فقط عند عدم وجود ClashAnime HLS. معطّلة افتراضياً.",
