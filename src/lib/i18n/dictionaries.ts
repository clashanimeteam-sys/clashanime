...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    admin: {
      ...
      watchAnimeAutoTitle: "Fallback embed servers (ads)",
      watchAnimeAutoHint: "VidKing, VidLink, VidSrc — only when no ClashAnime HLS source. Off by default for ad-free viewing.",
  ...
  ja: {
    ...
    animeSearch: {
      buttonLabel: "アニメ検索",
      title: "アニメ検索",
      placeholder: "アニメ作品を検索...",
      hint: "日本語・英語・アラビア語で検索できます",
      loading: "検索中...",
      empty: "該当するアニメがありません。",
      viewClips: "サイトのクリップ",
      viewTracker: "新作レーダー",
    ...
    admin: {
      ...
      watchAnimeAutoTitle: "予備embedサーバー（広告あり）",
      watchAnimeAutoHint: "ClashAnime HLSがない場合のみ VidKing / VidLink / VidSrc。デフォルトはオフ。",
      watchAnimeAutoOn: "有効",
      ...
      ads: {
        title: "広告配置",
        subtitle: "手動AdSenseバナーとリール広告スライドの表示場所を選びます。",
        controlsTitle: "配置コントロール",
        livePreviewTitle: "ライブプレビュー",
        livePreviewSubtitle: "AdSense承認前の見た目を確認できます。",
        masterToggle: "手動広告配置を有効化",
        previewToggle: "プレビュー枠を表示（Slot ID設定前）",
        reelsInterval: "リール: N本ごとに広告",
        reelsIntervalValue: "{n}本ごと",
        reelsIntervalHint: "縦動画の間に全画面広告スライド（オーバーレイ不可）。",
        reelsTimelineTitle: "リール順序",
        ...
        previewAdBlock: "広告",
        videoShort: "V",
        previewOnSite: "サイトを開く",
        adsenseNote: "本番広告はGoogle AdSense承認後に表示されます。Auto adsとは別設定です。",
        on: "ON",
        off: "OFF",
        save: "配置を保存",
        saving: "保存中…",
  ...
  ar: {
    ...
    animeSearch: {
      buttonLabel: "بحث عن أنمي",
      title: "بحث الأنمي",
      placeholder: "ابحث عن مسلسل أنمي...",
      hint: "ابحث بالعربية أو الإنجليزية أو اليابانية",
      loading: "جارٍ البحث...",
      empty: "لا توجد نتائج.",
    ...
    admin: {
      ...
      watchAnimeAutoTitle: "سيرفرات احتياطية (إعلانات)",
      watchAnimeAutoHint: "VidKing وVidLink وVidSrc — فقط عند عدم وجود ClashAnime HLS. معطّلة افتراضياً للمشاهدة بدون إعلانات.",
      ...
      ads: {
        ...
        masterToggle: "تفعيل الإعلانات اليدوية",
        previewToggle: "إظهار معاينة وهمية (حتى إضافة Slot ID)",
        reelsInterval: "الريلز: إعلان كل N فيديو",
        reelsIntervalValue: "كل {n} فيديو",
        reelsIntervalHint: "شريحة إعلان كاملة بين الفيديوهات — ليس فوق الفيديو.",
        reelsTimelineTitle: "تسلسل الريلز",
        ...
        videoShort: "ف",
        previewOnSite: "فتح الموقع",
        adsenseNote: "الإعلانات الحقيقية تظهر بعد موافقة Google AdSense. Auto ads في AdSense إعداد منفصل.",
        on: "تشغيل",
        off: "إيقاف",
        save: "حفظ المواضع",
        saving: "جارٍ الحفظ…",
        saved: "تم حفظ مواضع الإعلانات.",
        pages: {
          home: "الرئيسية",
          blog: "دليل الأبطال (/blog)",
