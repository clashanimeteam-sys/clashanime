  ...
  en: {
    ...
    admin: {
      ...
      platformHealth: {
        ...
        active: "Active for visitors when ads are configured.",
        inactive: "Disabled or overridden by env.",
        offUntilAdsense: "Off until AdSense env vars are configured.",
        checking: "Checking?",
