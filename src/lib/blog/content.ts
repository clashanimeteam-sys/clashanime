      ...
      en: {
        ...
        sections: [
          ...
          },
          {
            ...
            hype: "Don’t let your points sit idle! Every ClashCoin is an investment in your arena identity — rare frames, titles, and the aura of a boss.",
            body: "ClashCoins live in your wallet (USD cents). Typical paths:\n• Season / Top podium prizes can reach about $100 / $500 / $1,000 depending on the live pool\n• Conversion when eligible: ~10,000 hunter points = $10 ClashCoins\n• Minimum withdrawal: $10 after KYC\n• Payouts: bank transfer, PayPal, or USDT where allowed\n• Episode clash #1 is +2,000 points (rank fuel), not cash by itself\n\nAlways check live Earn money (/earn) rules — campaigns change.",
            tip: "Quality clips + clean engagement beat fake likes. Fraud voids prizes and ranks.",
          },
          {
            heading: "Don’t stop at Newbie — chase Clash Master",
            hype: "Don’t stop at Newbie — real heroes climb to the top. Every clash you upload pulls you closer to the Clash Master title.",
            body: "Profile → Bounty Hunter System (#hunter-system). Five ranks:\n• Newbie — 0–999 · vote & comment\n• Explorer — 1,000–2,999 · upload duels (+ community posts at 1,000+)\n• Duelist — 3,000–5,999 · double-weight votes\n• Master — 6,000–9,999 · Master badge & ranking priority\n• Clash Master — 10,000–20,000 · verification eligibility\n\nFast point hits: +25 signup · +10 invite visit · +100 friend signup · +50 referred bonus · +200 friend’s first video · +150 friend’s first duel · +20 certified upload · +2,000 episode clash win.",
            tip: "Climb with referrals and first-duel uploads — those bonuses stack faster than silent scrolling.",
          },
          {
            heading: "The arena needs rivals — invite your crew",
            hype: "The arena is incomplete without rivals. Invite friends, start the challenge, and climb the leaderboard together.",
            body: "Share your referral link from Profile. Unique visits, signups, and your friends’ first uploads/duels feed your hunter points — and give them a stronger start too.",
            ...
            roadmap: [
              {
                ...
                detail: "Sign up on clashanime.com, pick a unique username, and finish avatar + bio so voters recognize you.",
              },
              {
          ...
          },
          {
            ...
            body: "Home or /tracker → live clash → Enter → upload a sharp 15–60s clip → add #clashanime + every clash tag → share for votes.",
            tip: "Wrong hashtags can hide you from the clash board. Copy tags from the clash page exactly.",
          },
          {
            heading: "Trust of legends: privacy & credibility",
            body: "Account data powers auth, moderation, Earn money, and watch access — we don’t sell it. KYC before cash. Public boards, Terms, and reports keep the arena fair.",
            tip: "One real account only. Multi-account abuse can ban the whole climb.",
          },
        ],
      },
      ar: {
        ...
        sections: [
          ...
          },
          {
            ...
            hype: "لا تدع نقاطك تضيع! كل ClashCoin هو استثمار في هويتك داخل الساحة. استبدلها بإطارات نادرة وألقاب تجعل الجميع يعرفون من هو الزعيم.",
            body: "ClashCoins في محفظتك (سنتات بالدولار). المسارات المعتادة:\n• جوائز منصة الموسم / Top قد تصل تقريباً إلى 100$ / 500$ / 1,000$ حسب الصندوق الحي\n• التحويل عند الاستحقاق: تقريباً 10,000 نقطة = 10$ ClashCoins\n• الحد الأدنى للسحب: 10$ بعد KYC\n• السحب: تحويل بنكي أو PayPal أو USDT حيث يُسمح\n• فوز نزال الحلقة = +2,000 نقطة (وقود رتبة) وليس كاشاً مباشرة\n\nراجع دائماً قواعد اربح الأموال (/earn) — الحملات تتغيّر.",
            tip: "مقاطع نظيفة + تفاعل حقيقي أقوى من الإعجابات الوهمية. الاحتيال يلغي الجوائز والرتب.",
          },
          {
            heading: "لا تتوقف عند Newbie — طارد لقب Clash Master",
            hype: "لا تتوقف عند رتبة Newbie، الأبطال الحقيقيون هم من يصلون للقمة. كل نزال ترفعه يقربك خطوة من لقب «سيد النزالات» (Clash Master).",
            body: "الملف الشخصي → نظام صياد الجوائز (#hunter-system). خمس رتب:\n• Newbie — 0–999 · تصويت وتعليق\n• Explorer — 1,000–2,999 · رفع نزالات (+ مجتمع من 1,000)\n• Duelist — 3,000–5,999 · تصويت مزدوج\n• Master — 6,000–9,999 · شارة ماستر وأولوية ترتيب\n• Clash Master — 10,000–20,000 · أهلية التوثيق\n\nضربات نقاط سريعة: +25 تسجيل · +10 زيارة دعوة · +100 تسجيل صديق · +50 إن سجّلت عبر صديق · +200 أول فيديو لصديقك · +150 أول نزال لصديقك · +20 رفع موثّق · +2,000 فوز نزال حلقة.",
            tip: "اصعد بالإحالات وأول رفع/نزال للأصدقاء — هذه المكافآت أسرع من التمرير الصامت.",
          },
          {
            heading: "الساحة تحتاج منافسين — ادعُ طاقمك",
            hype: "الساحة لا تكتمل إلا بالمنافسين. ادعُ أصدقاءك، ابدأوا التحدي، واصعدوا معاً في لوحة الصدارة.",
            body: "شارك رابط الدعوة من الملف. الزيارات الفريدة والتسجيلات وأول رفع/نزال لأصدقائك تغذّي نقاط صيادك — وتعطيهم بداية أقوى أيضاً.",
            ...
            roadmap: [
              {
                ...
                title: "سجّل حسابك",
                detail: "أنشئ حساباً على clashanime.com، اختر اسم مستخدم فريداً، وأكمل الصورة والنبذة ليتعرّف عليك المصوّتون.",
              },
              {
          ...
          {
            heading: "ادخل نزالك الأول — أحدث ضجيجاً",
            body: "الرئيسية أو /tracker → نزال مباشر → ادخل → ارفع مقطعاً حاداً 15–60 ثانية → #clashanime + هاشتاغات النزال → شارك للأصوات.",
            tip: "الهاشتاغ الخاطئ قد يخفيك عن لوحة النزال. انسخ الهاشتاغات من صفحة النزال حرفياً.",
          },
          {
            heading: "ثقة الأساطير: الخصوصية والمصداقية",
            body: "بيانات الحساب تشغّل الدخول والإشراف واربح الأموال والمشاهدة — ولا نبيعها. KYC قبل الكاش. اللوحات العامة والشروط والإبلاغ تحافظ على عدالة الساحة.",
            tip: "حساب حقيقي واحد فقط. إساءة الحسابات المتعددة قد تحظر الصعود كله.",
          },
        ],
      },
      ja: {
        ...
        sections: [
          ...
          },
          {
            ...
            hype: "ポイントを遊ばせるな！ClashCoinはアリーナでのアイデンティティへの投資。希少なフレームと称号でボスの気配を示せ。",
            body: "ClashCoinsはウォレット内（USDセント）。目安：\n• シーズン表彰台は約 $100 / $500 / $1,000（プール次第）\n• 変換：約10,000pt = $10（対象時）\n• 最低出金：$10（KYC後）\n• 出金：銀行 / PayPal / USDT（許可地域）\n• クラッシュ1位は+2,000pt（ランク燃料）で現金そのものではない\n\n最新ルールは「お金を稼ぐ」(/earn) で確認。",
            tip: "質の高いクリップと公正な拡散が偽いいねに勝つ。不正は賞とランクを失う。",
          },
          {
            heading: "Newbieで止まるな — Clash Masterを追え",
            hype: "Newbieで止まるな。真の英雄は頂点へ。投稿するたびに Clash Master（クラッシュの覇者）へ一歩近づく。",
            body: "プロフィール → 賞金ハンター。5ランク：\n• Newbie — 0–999 · 投票・コメント\n• Explorer — 1,000–2,999 · デュエル投稿\n• Duelist — 3,000–5,999 · 投票2倍\n• Master — 6,000–9,999 · バッジと順位優先\n• Clash Master — 10,000–20,000 · 認証資格\n\n高速ポイント：+25登録 · +10招待訪問 · +100友達登録 · +50被招待 · +200初投稿 · +150初デュエル · +20認定投稿 · +2,000クラッシュ勝利。",
            tip: "招待と友達の初投稿／初デュエルで登れ — 黙ってスクロールするより速い。",
          },
          {
            heading: "アリーナにはライバルが必要 — 仲間を呼べ",
            hype: "アリーナはライバルがいて完成する。友達を誘い、挑戦を始め、一緒に順位を上げろ。",
            body: "プロフィールの招待リンクを共有。訪問・登録・友達の初投稿／初デュエルがあなたのポイントを育て、相手のスタートも強くする。",
            ...
            roadmap: [
              {
                label: "ステップ1 · 基盤",
                title: "アカウントを作成",
                detail: "clashanime.com で登録し、ユニークなユーザー名とアバター／自己紹介を整える。",
              },
              {
                label: "ステップ2 · 挑戦",
                title: "「お金を稼ぐ」へ進め",
          ...
          {
            heading: "最初のクラッシュへ — 音を立てろ",
            body: "ホームまたは /tracker → ライブクラッシュ → 参加 → 15–60秒のシャープなクリップ → #clashanime + 必須タグ → 共有して票を集める。",
            tip: "タグ違いで順位から消えることがある。クラッシュページのタグをそのまま使え。",
          },
          {
