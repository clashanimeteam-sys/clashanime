-- Production script: Hunter rank system v2
-- Run in Supabase SQL editor after deploy if migration was not applied automatically.
...
select
  public.points_to_level(0) as newbie,
  public.points_to_level(1000) as explorer,
  public.points_to_level(3000) as duelist,
  public.points_to_level(6000) as master,
  public.points_to_level(10000) as clash_master;
